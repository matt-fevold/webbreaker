...
def test_webinspect_list_two_servers_with_scan_name(list_scan_mock, runner):
    ...
    # Run the CLI proxy --list
    runner.invoke(webbreaker, ['webinspect', 'list', '--server', 'server1', '--server', 'server2', '--scan_name', 'important_site'])
...
def test_webinspect_download_extension(download_mock, runner):
    ...
    # Run the CLI proxy --list
    runner.invoke(webbreaker, ['webinspect', 'download', '--server', 'server', '--scan_name', 'important_site', '-x', 'xml'])
...
def test_webinspect_scan(scan_mock, runner):
    ...
    scan_mock.assert_called_once_with({'username': None, 'start_urls': (), 'scan_scope': None, 'upload_policy': None,
                                       ...
                                       'upload_settings': None, 'password': None, 'size': None, 'settings': 'Default',
...
def test_webinspect_scan_custom_settings(scan_mock, runner):
    ...
    scan_mock.assert_called_once_with({'username': None, 'start_urls': (), 'scan_scope': None, 'upload_policy': None,
                                       'upload_webmacros': None, 'scan_start': None, 'workflow_macros': (),
                                       'upload_settings': None, 'password': None, 'size': None, 'settings': 'important_site_auth',
                                       'scan_name': None, 'login_macro': None, 'scan_policy': None, 'allowed_hosts': (),
                                       'fortify_user': None, 'scan_mode': None})
...
def test_webinspect_scan_custom_settings_with_username_password(scan_mock, runner):
    ...
    # Run the CLI proxy --list
    runner.invoke(webbreaker, ['webinspect', 'scan', '--settings', 'important_site_auth', '--username', 'user', '--password', 'pass'])

    scan_mock.assert_called_once_with({'username': 'user', 'start_urls': (), 'scan_scope': None, 'upload_policy': None,
                                       'upload_webmacros': None, 'scan_start': None, 'workflow_macros': (),
                                       'upload_settings': None, 'password': 'pass', 'size': None, 'settings': 'important_site_auth',
                                       'scan_name': None, 'login_macro': None, 'scan_policy': None, 'allowed_hosts': (),
                                       'fortify_user': None, 'scan_mode': None})
...
def test_webinspect_scan_custom_settings_with_two_allowed_hosts(scan_mock, runner):
    ...
    # Run the CLI proxy --list
    runner.invoke(webbreaker, ['webinspect', 'scan', '--settings', 'important_site_auth', '--allowed_hosts', 'example.com',
                               '--allowed_hosts', 'example1.com'])

    scan_mock.assert_called_once_with({'username': None, 'start_urls': (), 'scan_scope': None, 'upload_policy': None,
                                       'upload_webmacros': None, 'scan_start': None, 'workflow_macros': (),
                                       'upload_settings': None, 'password': None, 'size': None, 'settings': 'important_site_auth',
                                       'scan_name': None, 'login_macro': None, 'scan_policy': None,
                                       'allowed_hosts': ('example.com', 'example1.com',), 'fortify_user': None, 'scan_mode': None})
...
def test_webinspect_scan_local_custom_settings(scan_mock, runner):
    ...
    scan_mock.assert_called_once_with({'username': None, 'start_urls': (), 'scan_scope': None, 'upload_policy': None,
                                       'upload_webmacros': None, 'scan_start': None, 'workflow_macros': (),
                                       'upload_settings': None, 'password': None, 'size': None, 'settings': '/users/me/important_site_auth',
                                       'scan_name': None, 'login_macro': None, 'scan_policy': None,
                                       'allowed_hosts': (), 'fortify_user': None, 'scan_mode': None})
...
def test_webinspect_scan_req(main_open_mock, open_mock, scan_mock, endpoint_mock, email_mock, runner, caplog):
    ...
    caplog.check(
        ...
        ('__webbreaker__', 'INFO', 'Using webinspect server: -->test.hq.target.com<-- for query'),
...
def test_webinspect_proxy_upload(proxy_mock, runner):
    ...
    proxy_mock.assert_called_once_with(False, False, None, 'test', False, None, False, False, 'test-proxy.webmacro', False,
                                       None, None)
