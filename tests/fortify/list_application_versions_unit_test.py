...
# mock config to skip reading from config
...
def test_fortify_list_success(auth_mock, list_all_mock, get_token_mock, config_mock):
...
@mock.patch('webbreaker.fortify.list_application_versions.FortifyAuth')
def test_fortify_list_application_success(auth_mock, list_application_mock, get_token_mock, config_mock):
    auth_mock.return_value.authenticate.return_value = ('user', 'pass')
    get_token_mock.return_value.get_token.return_value = 'a valid token'
