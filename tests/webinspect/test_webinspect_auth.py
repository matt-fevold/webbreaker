...
@mock.patch('webbreaker.webinspect.authentication.SecretClient')
@mock.patch('webbreaker.webinspect.authentication.config')
...
@mock.patch('webbreaker.webinspect.authentication.auth_prompt')
@mock.patch('webbreaker.webinspect.authentication.SecretClient')
@mock.patch('webbreaker.webinspect.authentication.config')
