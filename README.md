...
1. Add your _Threadfix_ URL and API Token to [webbreaker/etc/threadfix.ini]
(https://github.com/target/webbreaker/blob/master/webbreaker/etc/threadfix.ini#L2)
